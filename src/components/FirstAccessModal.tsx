...
export const FirstAccessModal: React.FC<FirstAccessModalProps> = ({
  ...
  // Password strength checks (Flexible: min 4 chars, any combination of letters, numbers or symbols)
              ...
              <div className="space-y-4">
                ...
                <div className="p-3.5 bg-slate-50 border border-slate-200 rounded-xl">
                  ...
                  <p className="text-[11px] text-slate-500 mt-2">
                    💡 Você pode usar letras, números e caracteres especiais como preferir (ex: minhalinha123, senha#2026).
                  </p>
                </div>
              </div>
